namespace ERPChess
{
    ...
    public class frmSalePlant : Form
    {
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            if (this.checkBoxPA.Checked)
            {
                ...
                else if (TGlobals.currentActor.PlantA.PL2.PLAttribute != ProductLineAttribute.无)
                {
                    flag = true;
                }
                else if (TGlobals.currentActor.PlantA.PL3.PLAttribute != ProductLineAttribute.无)
                {
                    flag = true;
                }
                else if (TGlobals.currentActor.PlantA.PL4.PLAttribute != ProductLineAttribute.无)
                {
                    flag = true;
                }
                TGlobals.currentActor.PlantA.PlantAttribute = !flag ? PlantAttribute.无 : PlantAttribute.租赁;
                int purchasePrice = TGlobals.currentActor.PlantA.PurchasePrice;
                TOperatingSheet operatingSheet = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                operatingSheet.Plant -= purchasePrice;
                TOperatingSheet sheet2 = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                sheet2.ReceivableAccountsQ4 += purchasePrice;
            }
            if (this.checkBoxPB.Checked)
            {
                ...
                else if (TGlobals.currentActor.PlantB.PL6.PLAttribute != ProductLineAttribute.无)
                {
                    flag2 = true;
                }
                else if (TGlobals.currentActor.PlantB.PL7.PLAttribute != ProductLineAttribute.无)
                {
                    flag2 = true;
                }
                TGlobals.currentActor.PlantB.PlantAttribute = !flag2 ? PlantAttribute.无 : PlantAttribute.租赁;
                int purchasePrice = TGlobals.currentActor.PlantB.PurchasePrice;
                TOperatingSheet operatingSheet = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                operatingSheet.Plant -= purchasePrice;
                TOperatingSheet sheet4 = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                sheet4.ReceivableAccountsQ4 += purchasePrice;
            }
            if (this.checkBoxPC.Checked)
            {
                ...
                TGlobals.currentActor.PlantC.PlantAttribute = !flag3 ? PlantAttribute.无 : PlantAttribute.租赁;
                int purchasePrice = TGlobals.currentActor.PlantC.PurchasePrice;
                TOperatingSheet operatingSheet = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                operatingSheet.Plant -= purchasePrice;
                TOperatingSheet sheet6 = TGlobals.currentActor.CurrBusinessConditions.OperatingSheet;
                sheet6.ReceivableAccountsQ4 += purchasePrice;
            }
        }
        ...
        private void frmSalePlant_Load(object sender, EventArgs e)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox2.Text = "卖出厂房的价格和买入时一致，款项放入应收款的第四期。";
            ...
            this.buttonCancel.Location = new Point(470, 0xd6);
            ...
            this.buttonOK.Location = new Point(0x180, 0xd6);
            ...
            base.ClientSize = new Size(0x233, 0xf9);
            ...
            base.Name = "frmSalePlant";
            base.ShowInTaskbar = false;
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "变卖厂房";
            base.Load += new EventHandler(this.frmSalePlant_Load);
